...
- [ ] User Settings > My Account: Ensure **2FA** is enabled (using an authenticator app and/or security key), Remove a phone
...
- [ ] User Settings > Content & Social > Social Permissions > Direct Messages: Allow DMs from other server members > **Disabled**
...
- [ ] User Settings > Data & Privacy > Allow my voice to be recorded in Clips > **Disabled**
- [ ] User Settings > Authorized Apps: Review and **Deauthorize** any unnecessary apps
- [ ] User Settings > Devices: Review and remove unnecessary devices, or **Log Out All Known Devices (Option at bottom of page)**
...
- Should avoid using messaging such as DMs outside of the server and only community via official public or private channels within the Discord Server
...
- Server Settings > Safety Setup > DM and Spam Protection:
...
- Server Settings > Safety Setup > AutoMod:
  ...
  - [ ] Configure custom keyword filters based on phrases/regex and exempted roles
...
- Server Settings > Access > Server Rules > **Enable** and include the preset rules or your own rules
  - This forces user to accept your server rules prior to entering and also enables another step to stop bots from joining
...
> restrict: Administrator, Manage Webhooks, Manage Server, Manage Roles, & Manage Channels. Never give Admin or Kick/Ban
...
> but to retain some redundancy. Although we recommend to now give any roles administrator natively and recommend using a security bot to give administrative permissions in a time-bound manner.
>
...
- Advanced Settings: Have verification bot filter based on account age, PFP set, and timeout for incomplete captcha
...
- Use a logging bot like Logger or [Dyno](https://dyno.gg/) to send detailed logs
...
creation/deletion. [Wick](https://wickbot.com/) is a good example of a bot in this category.
...
Consider bots like [Dyno](https://dyno.gg/) for advanced moderation and logging, or Carl-bot for reaction roles and custom commands. Set
...
- [ ] Add a profile picture in **My Account > Edit User Profile**
...
- Subscribe to [Discord status](https://discordstatus.com/) to get alerts on anytime Discord may be having issues
